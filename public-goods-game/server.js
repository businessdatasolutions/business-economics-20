...
function gameOver() {
    ...
    // Optional: Reset state for a new game?
    // gameState.status = 'lobby';
    // gameState.players = {}; // Clear players? Careful if instructor is still connected
    // gameState.groups = [];
    // gameState.resultsHistory = [];
            ...
            // case 'nextStage': ...
             case 'nextRound': // Triggered by instructor after viewing feedback
                if (gameState.status === 'running' && gameState.currentStage === 'feedback') {
                 ...
                 break;
            // Add other commands if needed (e.g., pause, reset)
        }
    });
